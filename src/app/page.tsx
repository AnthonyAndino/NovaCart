        ...
        <div className="min-h-screen">
            ...
            <section className="relative bg-gradient-to-r from-blue-600 text-white">
                <div className="max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-x1 mb-8 text-blue-100">
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3x1 font-bold text-gray-900 mb-8 text-center">
                        Categories
                    </h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {categories.map((category) => (
                            ...
                            >
                                ...
                                src={category.image}
                                alt={category.name}
                                className="w-full h-40 object-cover group-hover:sclae-110 transition duration-300"
                                />
                                <div className="absolute inset-0 bg-black/40 felx items-center justify-center">
                                    <span className="text-white text-x1 font-semibold">
                                        {category.name}
                                    </span>
                                </div>
                            </Link>
            ...
            <section className="py-16">
                <div className="max-w-7x1 mx-auto px-4 sm:px-6 lg-px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                        {featuredProducts.map((product) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <h3 className="text-lg font-semibold text0gray-900 mb-2">
                                        {product.name}
                                    </h3>
                    ...
                    <div className="text-center mt-12">
                        <Link
                        href="/"
                        className="inline-block border-2 border-blue-600 text-blue-600 px-8 py-3 rounde-lg font-semibold hover:bg-blue-600 hover:text-white transition"
                        >
